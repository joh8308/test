                ...
                <Grid>
                  <Row>
                    <Col xs={6} style={{paddingTop: 25}}>
                      <div><img src='/imgs/app/shots/liontechlogo.jpg' /></div><br/>
                      <address>
                ...
                <Grid>
                  <Row>
                    <Col xs={8}>
                      ...
                      <p>
                        <img src='/imgs/app/shots/paypal.jpg' style={{marginLeft: -8, marginRight: -8}} />
                      </p>
                    </Col>
                    <Col xs={4}>
                ...
                <Grid className='hidden-print'>
                  <Row>
                    <Col xs={12} className='text-right'>
                      <div><Button outlined lg bsStyle='darkgrayishblue75' onClick={::this.print}>print invoice</Button></div><br/>
                    </Col>
                  </Row>
                </Grid>
              </PanelBody>
