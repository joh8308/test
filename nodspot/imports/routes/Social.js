    ...
    return (
      <div style={{height: 350, marginTop: -25, backgroundImage: 'url(/imgs/app/shots/Blick_auf_Manhattan.JPG)', backgroundSize: 'cover', position: 'relative', marginBottom: 25, backgroundPosition: 'center'}}>
        ...
        <div className='social-avatar'>
          <Image src='/imgs/app/avatars/john.jpg' height='100' width='100' style={{display: 'block', borderRadius: 100, border: '2px solid #fff', margin: 'auto', marginTop: 50}} />
          <h4 className='fg-white text-center'>John Jeong</h4>
          <h5 className='fg-white text-center' style={{opacity: 0.8}}>DevTeam Researcher, KR</h5>
              ...
              <PanelContainer>
                <PanelBody style={{padding: 25, paddingTop: 12.5}}>
                  ...
                  <div style={{margin: -25, marginTop: 25}}>
                    <Image responsive src='/imgs/app/gallery/tumblr_n8zm8ndGiY1st5lhmo1_1280.jpg' />
                  </div>
                </PanelBody>
                ...
                <PanelFooter style={{padding: 25, paddingTop: 0, paddingBottom: 0}}>
                  <div className='inbox-avatar' style={{borderBottom: '1px solid #EAEDF1'}}>
                    <img src='/imgs/app/avatars/avatar0.png' width='30' height='30' style={{verticalAlign: 'top', top: 10, position: 'relative'}} />
                    <div className='inbox-avatar-name'>
                  ...
                  <div className='inbox-avatar' style={{borderBottom: '1px solid #EAEDF1'}}>
                    <img src='/imgs/app/avatars/avatar9.png' width='30' height='30' style={{verticalAlign: 'top', top: 10, position: 'relative'}} />
                    <div className='inbox-avatar-name'>
                  ...
                  <div className='inbox-avatar' style={{borderBottom: '1px solid #EAEDF1'}}>
                    <img src='/imgs/app/avatars/avatar7.png' width='30' height='30' style={{verticalAlign: 'top', top: 10, position: 'relative'}} />
                    <div className='inbox-avatar-name'>
                      <div className='fg-darkgrayishblue75'>Ava Parry</div>
                ...
                <PanelFooter style={{padding: 12.5}}>
                  <FormControl componentClass='textarea' rows='1' placeholder='Write a comment...' style={{border: 'none'}} />
                </PanelFooter>
              </PanelContainer>
            </Col>
            <Col sm={6}>
              <PanelContainer>
                <PanelBody style={{padding: 25, paddingTop: 12.5}}>
                  <div className='inbox-avatar'>
                    <img src='/imgs/app/avatars/avatar5.png' width='40' height='40' />
                    <div className='inbox-avatar-name'>
              ...
              <PanelContainer>
                <PanelBody style={{padding: 25, paddingTop: 12.5}}>
                  <div className='inbox-avatar'>
                    <img src='/imgs/app/avatars/avatar9.png' width='40' height='40' />
                    <div className='inbox-avatar-name'>
                      <div className='fg-darkgrayishblue75'>Ava Parry</div>
